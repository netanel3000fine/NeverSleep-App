...
- 🔌 **עירנות עד…** - כיבוי מתוזמן של המחשב
...
### עברית:
1. הורד את קובץ ההתקנה `Never Sleep_1.0.0_x64-setup.exe`
2. הרץ את ההתקנה
3. פתח את האפליקציה

### English:
1. Download `Never Sleep_1.0.0_x64-setup.exe`
2. Run the installer
3. Launch the app
...
- **פאנל ימין (עירנות עד…)**: הפעל טיימר לכיבוי המחשב
